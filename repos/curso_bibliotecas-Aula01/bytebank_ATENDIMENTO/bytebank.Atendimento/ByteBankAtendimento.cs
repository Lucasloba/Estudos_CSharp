    ...
    internal  class ByteBankAtendimento
    {
        ...
        private void ExportarContas()
        {
            ...
            else
            {
                ...
                try
                {
                    //isso aq é uma tentativa de serialização: o objeto a ser serializado é 
                    // a ´_listaDeContas´ que esta no else. Dentro aq do try tem a instancia 
                    // definindo em qual lugar o objeto será serializado/trasformado em arquivo
                    // do tipo ´.json´. Essas variaveis desconhecidas sao da biblioteca/pacote nuGet
                    // terceirizada ´NewtonSoft.Json´ que vc instalou.
                    FileStream fs = new FileStream(@"C:\temp\export\contas.json", FileMode.Create);
                    using (StreamWriter streamwriter = new StreamWriter(fs))
                    {
