    ...
    class Program
    {
        static void Main(string[] args)
        {
            var contas = new List<ContaCorrente>()
            {
                ...
                null,
                new ContaCorrente(342, 3),
                new ContaCorrente(342, 5),
                new ContaCorrente(340, 6),
                null,
                null,
                new ContaCorrente(290, 8)
            };
            ...
            // vai pegar a conta toda e mostrar so oq(onde) n é nulo
            ...
            // vai pegar a conta toda e organizar por conta.numero
        ...
        static void TestaSorte()
        {
            ...
            // Teste pra ver se ´Adicionar´ ta aceitando qlqr tipo de item msm
            ...
            // Fim teste (ta funcionando sim)

            Console.ReadLine();
            #region Removido Anotações Importantes
            ...
            //var conta = new ContaCorrente(7643, 76543);
