...
namespace ByteBank.Modelos
{
    ...
    public class ContaCorrente : IComparable 
    {
        ...
        //Ele quer saber se a instancia deve ficar na frente ou atras dentro do argumento
        public int CompareTo(object obj)
        {
            ...
            // ´var outraConta = obj as ContaCorrente´ faz conversão de outra conta em ContaCorrente 
            // ´as´ se a conversão falhar, `outraConta` vai ser nula
            // ContaCorrente outraConta = obj as ContaCorrente;
            ...
            if(outraConta == null)
            {
                //throw new ArgumentException("Isso não é uma conta");
                return -1;
            }
