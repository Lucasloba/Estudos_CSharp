...
namespace CursoCSharp.MetodosEFuncoes 
{
    public static class ExtensoesInteiro {
        ...
        public static double Subtracao(this double num, double outroNumero) { // double é int mas int n é double
            return num - outroNumero;
        }
    }
    ...
    class MetodosDeExtensao 
    {
        public static void Executar () {
            ...
            Console.WriteLine(numero.Soma(3)); // função Soma n existia, portanto, é anonima
